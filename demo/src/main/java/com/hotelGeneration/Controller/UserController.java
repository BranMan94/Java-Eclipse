 ...
 * 
 * Para poder decirle a JAVA que esta clase es un controller, necesitamos usar la anotacion @Controller. Esto nos ayudara a poder manejar solicitudes HTTP, y ademas con esta anotacion podremos maneja el fetch que tengamos en nuestro front.
 */
