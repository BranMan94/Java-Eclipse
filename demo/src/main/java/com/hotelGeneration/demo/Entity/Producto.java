...
public class Producto {
	...
	@Column (name = "id", unique = true, nullable = false) //se relaciona con la columna id, unique, not null
	private Long id;
	...
	public String toString() {
	    return "Producto [id=" + id + ", nombre=" + nombre + ", descripcion=" + descripcion + ", imagen=" + imagen + ", precio=" + precio + "]";
	}
